...
In order to make the most of your shiny new slider (introduced in version 1.2) you should do the following:
...
* Also you can assign an article image to the about article - dimensions are 60x60. It will only be displayed in the slider!
* Create a new link category called _social-media_
* Create as many links as you like ad assign them to the category _social-media_
* If you wish, you can also directly edit the content of the form _minimum_slider_ to suit your needs
