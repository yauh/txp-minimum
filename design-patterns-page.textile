...
In order to activate <a href="http://code.google.com/p/google-code-prettify/" rel="external" title="Go to the Google Code Prettify project page">Google Code Prettify</a>, use the following Textile markup @bc(prettyprint linenums).@
